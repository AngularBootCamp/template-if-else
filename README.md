# DRAFT - Angular Boot Camp Curriculum - template-if-else
...
[StackBlitz for template-if-else](https://stackblitz.io/github/AngularBootCamp/template-if-else)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/template-if-else.git
cd template-if-else
yarn
yarn start
```
