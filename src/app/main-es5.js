...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _if_else_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./if-else.component */
  ...
  /***/
  function srcAppIfElseComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "IfElseComponent", function () {
    ...
    function IfElseComponent_ng_container_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function IfElseComponent_ng_template_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function () {
      function IfElseComponent() {
        _classCallCheck(this, IfElseComponent);

        this.n = 0;
      }

      _createClass(IfElseComponent, [{
        key: "increment",
    ...
    IfElseComponent.ɵfac = function IfElseComponent_Factory(t) {
      return new (t || IfElseComponent)();
    };

    IfElseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: IfElseComponent,
      selectors: [["app-root"]],
      decls: 13,
      vars: 2,
      consts: [[1, "col", "s6"], [1, "card"], [1, "card-content"], [1, "card-title"], [1, "btn", 3, "click"], [4, "ngIf", "ngIfElse"]],
      template: function IfElseComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function IfElseComponent_Template_button_click_7_listener($event) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](IfElseComponent, [{
